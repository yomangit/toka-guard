...
$classes = Flux::classes()
    ->add('w-full max-w-sm border rounded-xs dark:outline-none block disabled:shadow-none dark:shadow-none ring-0 focus:ring-1 focus:border-info focus:ring-info focus:outline-hidden')
