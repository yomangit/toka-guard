    ...
    <x-manhours.layout>
        ...
        <form wire:submit.prevent="submit">
                    ...
                    <div class="collapse-content text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 ">
                            <fieldset class=" fieldset">
                                ...
                                @if ($doc_deskripsi)
                                    @if (in_array($doc_deskripsi->getClientOriginalExtension(), ['jpg', 'jpeg', 'png']))
                                        <img src="{{ $doc_deskripsi->temporaryUrl() }}"
                                            class="mt-2 w-40 h-auto rounded border" />
                                    @else
                                ...
                                <input name="doc_deskripsi" id="upload-deskripsi" wire:model.live='doc_deskripsi'
                                ...
                                <li class="p-2">
                                    <div class="relative w-full">
                                        <input name="manualPelaporName" type="text"
                                            wire:model.live="manualPelaporName" placeholder="Masukkan nama pelapor..."
                                        ...
                                        <div class="!absolute top-1/2 -translate-y-1/2 right-0 z-20">
                                            <flux:button size="xs" wire:click="addPelaporManual" icon="plus"
                                                variant="primary">
                                                Tambah
                                            </flux:button>
                                        </div>
            ...
            <fieldset class="fieldset ">
                ...
                <div class="relative">
                    <!-- Input Search -->
                    <input name="searchLocation" type="text" wire:model.live.debounce.300ms="searchLocation"
            ...
            <fieldset class="fieldset relative">
                ...
                Livewire.hook('message.processed', () => {
                    ...
                    <input name="tanggal" type="text" x-ref="tanggalInput" wire:model.live='tanggal'
                                        ...
                                        <ul
                                            ...
                                            @if (count($pelaporsAct) > 0)
                                                @foreach ($pelaporsAct as $pelapor)
                                                    <li wire:click="selectActPelapor({{ $pelapor->id }}, '{{ $pelapor->name }}')"
                                                        class="px-3 py-2 cursor-pointer hover:bg-base-200">
                                                        {{ $pelapor->name }}
                                                    </li>
                                                @endforeach
                                            ...
                                            @if ($manualActPelaporMode)
                                                <li class="p-2">
                                                    <div class="relative w-full">
                                                        <input name="manualActPelaporName" type="text"
