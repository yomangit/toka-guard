    ...
    <x-manhours.layout>
        <form wire:submit.prevent="submit">
            ...
            <div class="hidden md:block flex justify-end mt-4">
                <flux:button size="xs" type="submit" onclick="return validateDescription()" icon:trailing="send" variant="primary">Kirim Laporan
                </flux:button>
            </div>
            <div class="block md:hidden  mt-4">
                <flux:button size="xs" class="w-full" type="submit" onclick="return validateDescription()" icon:trailing="send" variant="primary">
