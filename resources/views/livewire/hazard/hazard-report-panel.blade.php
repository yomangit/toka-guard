            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <fieldset>
                    <div class="flex items-center space-x-2 mb-2">
                        ...
                        <x-form.label for="department" class="peer-checked/department:text-accent text-[10px] md:text-xs" label="PT. MSM & PT. TTN" />
                        ...
                        <x-form.label for="company" class="peer-checked/company:text-primary text-[10px] md:text-xs" label="Kontraktor" />
                    </div>
