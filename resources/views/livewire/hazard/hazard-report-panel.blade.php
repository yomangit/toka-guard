                        ...
                        <div class="relative inline-block">
                            ...
                            <button wire:click.prevent="toggleDropdownstatus" type="button" class="flex items-center space-x-1 font-semibold hover:text-blue-600">
                                ...
                                <span @if(empty($availableStatuses)) style="display: none;" @endif class="text-blue-600 text-xs">
                                    {{-- SVG Icon --}}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-list-filter-icon lucide-list-filter">
                                        <path d="M2 5h20" />
                                        <path d="M6 12h12" />
                                        <path d="M9 19h6" />
                                    </svg>
